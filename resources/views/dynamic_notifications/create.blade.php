    ...
    <div class="page-wrapper">
        ...
        <div>
            ...
            <div class="form-group col-12 text-center btm-btn">
                <button type="button" class="btn btn-primary edit-setting-btn send_message"><i class="fa fa-save"></i> {{ trans('lang.save') }}
                </button>
                ...
                if (requestId != '') {
                    ...
                    ref.get().then(async function(snapshots) {
                        if (snapshots.docs.length) {
                            ...
                            } else if (np.type == "assign_order") {
                                type = "{{ trans('lang.assign_order') }}";
                            } else if (np.type == "restaurant_cancelled") {
                                type = "{{ trans('lang.restaurant_cancelled') }}";
                            } else if (np.type == "driver_cancelled") {
                                type = "{{ trans('lang.driver_cancelled') }}";
                            } else if (np.type == "new_delivery_order") {
                                type = "{{ trans('lang.new_delivery_order') }}";
                            } else if (np.type == "advertisement_approved") {
                                type = "{{ trans('lang.advertisement_approved') }}";
                            } else if (np.type == "advertisement_cancelled") {
                                type = "{{ trans('lang.advertisement_cancelled') }}";
                            } else if (np.type == "advertisement_paused") {
                                type = "{{ trans('lang.advertisement_paused') }}";
                            } else if (np.type == "advertisement_resumed") {
