               ...
               <div class="card border">
                 <div class="card-header d-flex justify-content-between align-items-center border-0">
                   <div class="card-header-title">
                    <h3 class="text-dark-2 mb-2 h4">Customers List</h3>
                    <p class="mb-0 text-dark-2">View and manage all the customers</p>
                   </div>
                 </div>
                 <div class="card-body">
...
<script type="text/javascript">
    ...
    var customersPageInitialized = false;
            ...
            ajax: function (data, callback, settings) {
                ...
                ref.orderBy('createdAt', 'desc').get().then(async function (querySnapshot) {
                    ...
                    paginatedRecords.forEach(function (childData) {
                        var id = childData.id;
                        var route1 = '{{route("customers.edit",":id")}}';
    ...
    } // End of initCustomersPage function
