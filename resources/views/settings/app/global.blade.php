...
@section('scripts')
    <script>
        ...
        window.waitForFirestore(function(database) {
            ...
            // Initialize all Firestore references
            ...
            ref.get().then(async function(snapshots) {
                ...
                try {
                    ...
                    $("#api_secure_key").val(globalSettings.apiSecureKey);
            ...
            // Edit settings button click handler
            ...
            // Restaurant story upload checkbox handler
            ...
            // Handle file select for placeholder
            ...
            // Handle file select for favicon
