    ...
    <div class="page-wrapper">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">Restaurant Control - Edit</h3>
            </div>
                ...
                <div class="col-12">
                    <div class="resttab-sec">
                        <div class="menu-tab">
                            <ul>
                                <li class="active">
                                    <a href="{{ route('restaurants.control.edit.new', $id) }}">Restaurant Details</a>
                                </li>
                            </ul>
                        </div>
...
@section('scripts')
    ...
    <script>
        ...
        window.waitForFirestore(function(db) {
            ...
            console.log('🔄 [NEW EDIT] Restaurant ID:', id);
            console.log('🔄 [NEW EDIT] Database available:', !!database);
            
            if (!id || id === '' || id === undefined) {
                console.error('❌ [NEW EDIT] CRITICAL: Restaurant ID is empty or invalid!');
                console.error('❌ [NEW EDIT] Cannot create Firestore reference without ID');
            ...
            console.log('✅ [NEW EDIT] Vendors reference created');
            console.log('✅ [NEW EDIT] Reference path:', ref.path);
            console.log('✅ [NEW EDIT] Reference ID:', ref.id);
            ...
            console.log('✅ [NEW EDIT] All Firestore references initialized');
            console.log('🔄 [NEW EDIT] ============================================');
            ...
            console.log('✅ [NEW EDIT] ============================================');
            console.log('✅ [NEW EDIT] Firestore ready, initializing page...');
            console.log('✅ [NEW EDIT] Reference object:', ref ? 'OK' : 'NULL');
            console.log('✅ [NEW EDIT] Reference path:', ref ? ref.path : 'NOT SET');
            console.log('✅ [NEW EDIT] Reference ID:', ref ? ref.id : 'NOT SET');
            console.log('✅ [NEW EDIT] ============================================');
            updateStatusMessage('Firestore database connection established. Ready to load restaurant data.', 'success');
            
            // Small delay to ensure all references are ready
            setTimeout(function() {
        ...
        function initRestaurantEditPage() {
            console.log('🔄 [NEW EDIT] initRestaurantEditPage called');
            console.log('🔄 [NEW EDIT] ID from PHP:', id);
            console.log('🔄 [NEW EDIT] Database available:', !!database);
            
            updateStatusMessage('Initializing restaurant edit page...', 'info');
            
            if (!database) {
                console.error('❌ [NEW EDIT] Database not available');
                updateStatusMessage('Waiting for Firestore database to be ready...', 'warning');
                // Retry after a short delay
                setTimeout(function() {
                    if (database) {
                        console.log('✅ [NEW EDIT] Database now available, retrying...');
                        updateStatusMessage('Database ready, loading restaurant data...', 'success');
                        initRestaurantEditPage();
                    } else {
                        console.error('❌ [NEW EDIT] Database still not available after retry');
            ...
            if (!id || id === '' || id === undefined) {
                console.error('❌ [NEW EDIT] Restaurant ID is missing or invalid:', id);
                updateStatusMessage('Error: Restaurant ID is missing. Please check the URL.', 'error');
                toastr.error('Restaurant ID is missing. Please check the URL.');
                return;
            }
            ...
            console.log('🔄 [NEW EDIT] ============================================');
            console.log('🔄 [NEW EDIT] Starting data loading process...');
            console.log('🔄 [NEW EDIT] Restaurant ID:', id);
            var dbStatus = database ? 'Available' : 'NOT AVAILABLE';
            console.log('🔄 [NEW EDIT] Database instance:', dbStatus);
            var refStatus = ref ? 'Available' : 'NOT AVAILABLE';
            console.log('🔄 [NEW EDIT] Reference object:', refStatus);
            var refPath = ref ? ref.path : 'N/A';
            console.log('🔄 [NEW EDIT] Reference path:', refPath);
            console.log('🔄 [NEW EDIT] ============================================');
            
            // Validate prerequisites
            if (!database) {
                console.error('❌ [NEW EDIT] CRITICAL: Database is not initialized!');
            ...
            if (!ref) {
                console.error('❌ [NEW EDIT] CRITICAL: Reference is not initialized!');
            ...
            console.log('🔄 [NEW EDIT] Attempting to fetch document from Firestore...');
            console.log('🔄 [NEW EDIT] Collection: vendors');
            console.log('🔄 [NEW EDIT] Document ID:', id);
            ...
            ref.get().then(async function(docSnapshot) {
                console.log('🔄 [NEW EDIT] ============================================');
                console.log('🔄 [NEW EDIT] Firestore query completed');
                var snapshotStatus = docSnapshot ? 'Yes' : 'No';
                console.log('🔄 [NEW EDIT] Document snapshot received:', snapshotStatus);
                ...
                try {
                    if (!docSnapshot) {
                        console.error('❌ [NEW EDIT] CRITICAL: Document snapshot is null!');
                        console.error('❌ [NEW EDIT] This means the query returned no result.');
                        console.error('❌ [NEW EDIT] Possible causes:');
                    ...
                    if (!docSnapshot.exists) {
                        console.error('❌ [NEW EDIT] CRITICAL: Document does not exist!');
                        console.error('❌ [NEW EDIT] Document ID:', id);
                        console.error('❌ [NEW EDIT] Document exists:', false);
                        console.error('❌ [NEW EDIT] This restaurant ID does not exist in Firestore.');
                        console.error('❌ [NEW EDIT] Please verify the ID in Firestore console.');
                        jQuery("#data-table_processing").hide();
                        toastr.error('Restaurant not found! Please check the restaurant ID.');
                        return false;
                    }
                    
                    console.log('✅ [NEW EDIT] Document exists: YES');
                    console.log('✅ [NEW EDIT] Document ID:', docSnapshot.id);
                    console.log('🔄 [NEW EDIT] Extracting document data...');
                    updateStatusMessage('Extracting restaurant data from document...', 'info');
                    
                    var restaurant = docSnapshot.data();
                    if (!restaurant) {
                        console.error('❌ [NEW EDIT] CRITICAL: Document data is null!');
                    ...
                    console.log('✅ [NEW EDIT] Restaurant data extracted successfully!');
                    updateStatusMessage('Restaurant data extracted. Populating form fields...', 'success');
                    console.log('📋 [NEW EDIT] ============================================');
                    console.log('📋 [NEW EDIT] RESTAURANT DATA SUMMARY:');
                    console.log('📋 [NEW EDIT] Document ID:', restaurant.id);
                    var titleValue = restaurant.title || 'N/A (MISSING!)';
                    console.log('📋 [NEW EDIT] Title:', titleValue);
                    var zoneIdValue = restaurant.zoneId || 'N/A (MISSING!)';
                    console.log('📋 [NEW EDIT] Zone ID:', zoneIdValue);
                    var phoneValue = restaurant.phonenumber || 'N/A (MISSING!)';
                    console.log('📋 [NEW EDIT] Phone:', phoneValue);
                    var locationValue = restaurant.location || 'N/A (MISSING!)';
                    console.log('📋 [NEW EDIT] Location:', locationValue);
                    var latitudeValue = restaurant.latitude || 'N/A (MISSING!)';
                    console.log('📋 [NEW EDIT] Latitude:', latitudeValue);
                    var longitudeValue = restaurant.longitude || 'N/A (MISSING!)';
                    console.log('📋 [NEW EDIT] Longitude:', longitudeValue);
                    var descriptionStatus = restaurant.description ? 'Present' : 'MISSING!';
                    console.log('📋 [NEW EDIT] Description:', descriptionStatus);
                    var countryCodeValue = restaurant.countryCode || 'N/A (MISSING!)';
                    console.log('📋 [NEW EDIT] Country Code:', countryCodeValue);
                    var photosInfo = restaurant.photos ? '(' + restaurant.photos.length + ' photos)' : '(NO PHOTOS)';
                    console.log('📋 [NEW EDIT] Has Photos:', !!restaurant.photos, photosInfo);
                    var menuPhotosInfo = restaurant.restaurantMenuPhotos ? '(' + restaurant.restaurantMenuPhotos.length + ' photos)' : '(NO PHOTOS)';
                    console.log('📋 [NEW EDIT] Has Menu Photos:', !!restaurant.restaurantMenuPhotos, menuPhotosInfo);
                    var workingHoursInfo = restaurant.workingHours ? '(' + restaurant.workingHours.length + ' days)' : '(NO WORKING HOURS)';
                    console.log('📋 [NEW EDIT] Has Working Hours:', !!restaurant.workingHours, workingHoursInfo);
                    var specialDiscountInfo = restaurant.specialDiscount ? '(' + restaurant.specialDiscount.length + ' days)' : '(NO SPECIAL DISCOUNTS)';
                    console.log('📋 [NEW EDIT] Has Special Discount:', !!restaurant.specialDiscount, specialDiscountInfo);
                    console.log('📋 [NEW EDIT] Has Admin Commission:', !!restaurant.adminCommission);
                    var categoryInfo = restaurant.categoryID ? '(' + restaurant.categoryID.length + ' categories)' : '(NO CATEGORIES)';
                    console.log('📋 [NEW EDIT] Has Category ID:', !!restaurant.categoryID, categoryInfo);
                    console.log('📋 [NEW EDIT] Has Filters:', !!restaurant.filters);
                    console.log('📋 [NEW EDIT] ============================================');
                    ...
                    if (restaurant.countryCode != "" && restaurant.countryCode != null) {
                        ...
                        console.log('✅ [NEW EDIT] Country code loaded:', restaurant.countryCode);
                    }
                    ...
                    $(".restaurant_name").val(restaurant.title);
                        console.log('✅ [NEW EDIT] Restaurant name loaded:', restaurant.title);
                    }
                    
                    // Load Address
                    if (restaurant.location) {
                    $(".restaurant_address").val(restaurant.location);
                        console.log('✅ [NEW EDIT] Address loaded:', restaurant.location);
                    }
                    ...
                    $(".restaurant_latitude").val(restaurant.latitude);
                        console.log('✅ [NEW EDIT] Latitude loaded:', restaurant.latitude);
                    }
                    
                    // Load Longitude
                    if (restaurant.longitude) {
                    $(".restaurant_longitude").val(restaurant.longitude);
                        console.log('✅ [NEW EDIT] Longitude loaded:', restaurant.longitude);
                    }
                    
                    // Load Description
                    if (restaurant.description) {
                    $(".restaurant_description").val(restaurant.description);
                        console.log('✅ [NEW EDIT] Description loaded');
                    }
                    if (restaurant.photo) {
                    ...
                    if (restaurant.hasOwnProperty('categoryID') && restaurant.categoryID != null && restaurant.categoryID != '' && restaurant.categoryID.length > 0) {
                        ...
                        console.log('✅ [NEW EDIT] Selected categories from categoryID:', selected_category);
                        ...
                        console.log('✅ [NEW EDIT] Using cuisines from filters.Cuisine:', selected_category);
                    }
                    ...
                    await database.collection('vendor_categories').where('publish', '==', true).get().then(async function(snapshots) {
                        ...
                        console.log('✅ [NEW EDIT] Cuisines dropdown loaded with', categoriesCount, 'categories');
                    }).catch(function(error) {
                        console.error('❌ [NEW EDIT] Error loading cuisines:', error);
                    });
                    ...
                    if (restaurant.hasOwnProperty('phonenumber') && restaurant.phonenumber) {
                        $(".restaurant_phone").val(shortEditNumber(restaurant.phonenumber));
                        console.log('✅ [NEW EDIT] Phone number loaded');
                    }
                    ref_deliverycharge.get().then(async function(snapshots_charge) {
                        var deliveryChargeSettings = snapshots_charge.data();
                        try {
                    ...
                    if (restaurant.hasOwnProperty('zoneId') && restaurant.zoneId != '' && restaurant.zoneId != null) {
                        ...
                        console.log('✅ [NEW EDIT] Zone selected:', restaurant.zoneId);
                    }
                ...
                if (restaurant.hasOwnProperty('isSelfDelivery') && restaurant.isSelfDelivery != null && restaurant.isSelfDelivery != '' && restaurant.isSelfDelivery) {
                    $('#enable_self_delivery').prop('checked', true);
                        console.log('✅ [NEW EDIT] Self Delivery enabled');
                    }
                    ...
                    if (restaurant.hasOwnProperty('gst') && restaurant.gst != null && restaurant.gst != '') {
                        if ($("#gst").length) {
                            ...
                            console.log('✅ [NEW EDIT] GST loaded:', restaurant.gst);
                        }
                    }
                    ...
                    if (restaurant.hasOwnProperty('enableDND') && restaurant.enableDND) {
                        if ($("#enable_dnd").length) {
                            ...
                            console.log('✅ [NEW EDIT] DND enabled');
                        }
                    }
                    ...
                    console.log('✅ [NEW EDIT] All data loaded and displayed successfully!');
                    ...
                    console.error('❌ [NEW EDIT] ============================================');
                    console.error('❌ [NEW EDIT] CRITICAL ERROR in data processing!');
                    ...
                    console.error('❌ [NEW EDIT] Error Name:', errorNameValue);
                    var errorMessageValue = error.message || 'No message';
                    console.error('❌ [NEW EDIT] Error Message:', errorMessageValue);
                    var errorCodeValue = error.code || 'No code';
                    console.error('❌ [NEW EDIT] Error Code:', errorCodeValue);
                    var errorStackValue = error.stack || 'No stack trace';
                    console.error('❌ [NEW EDIT] Error Stack:', errorStackValue);
                    console.error('❌ [NEW EDIT] ============================================');
                    console.error('❌ [NEW EDIT] This error occurred while processing restaurant data.');
                    console.error('❌ [NEW EDIT] Possible causes:');
                ...
                console.error('❌ [NEW EDIT] ============================================');
                console.error('❌ [NEW EDIT] CRITICAL: Firestore query failed!');
                ...
                console.error('❌ [NEW EDIT] Error Name:', errorNameValue);
                console.error('❌ [NEW EDIT] ============================================');
                console.error('❌ [NEW EDIT] This error occurred while fetching from Firestore.');
                console.error('❌ [NEW EDIT] Possible causes:');
